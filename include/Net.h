...
public:
    ...
    bool syncGet(const std::string& host, const std::string& target, std::vector<std::pair<std::string, std::string>> default_headers, std::vector<std::pair<std::string, std::string>> extra_headers, std::string& body_out, int& status_out) {
